# unreal.SceneCaptureCube

```python
class unreal.SceneCaptureCube(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `capture_component_cube`: SceneCaptureComponentCube
...
**on_interp_toggle**( _enable_) → `None`
...
- `unreal.SceneCaptureCube`
  - `SceneCaptureCube`
    - `SceneCaptureCube.capture_component_cube`
    - `SceneCaptureCube.on_interp_toggle()`