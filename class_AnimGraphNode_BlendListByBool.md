...
```python
class unreal.AnimGraphNode_BlendListByBool(outer:Object | None=None, name:Name | str='None')
```
...
- **File**: AnimGraphNode\_BlendListByBool.h
...
- `node` (AnimNode\_BlendListByBool): [Read-Write]
