...
```python
class unreal.Font(outer:Object | None=None, name:Name | str='None')
```
...
- `composite_font` (CompositeFont): [Read-Write]
...
- `runtime_font_source` (RuntimeFontSource): [Read-Write] Where is the runtime font data for this Font stored?
