...
```python
class unreal.DeformableCollisionsComponent(outer:Object | None=None, name:Name | str='None')
```


**Bases:** ``DeformablePhysicsComponent``
...
- **File**: ChaosDeformableCollisionsComponent.h
...
- `collision_bodies` (Array[StaticMeshComponent]): [Read-Write]
...
**add_static_mesh_component**( _static_mesh_component_) → `None`

Add Static Mesh Component

Parameters:

**static\_mesh\_component** ( _StaticMeshComponent_)


---

_property_ `collision_bodies`: None
...
**remove_static_mesh_component**( _static_mesh_component_) → `None`
...
- `unreal.DeformableCollisionsComponent`
  - `DeformableCollisionsComponent`
    - `DeformableCollisionsComponent.add_static_mesh_component()`
    - `DeformableCollisionsComponent.collision_bodies`
    - `DeformableCollisionsComponent.remove_static_mesh_component()`