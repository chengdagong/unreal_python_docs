...
```python
class unreal.SceneCapture2D(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `capture_component2d`: SceneCaptureComponent2D
...
- `unreal.SceneCapture2D`
  - `SceneCapture2D`
    - `SceneCapture2D.capture_component2d`
    - `SceneCapture2D.on_interp_toggle()`