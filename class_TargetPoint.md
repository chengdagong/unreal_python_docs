...
```python
class unreal.TargetPoint(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `arrow_component`: ArrowComponent
...
_property_ `sprite_component`: BillboardComponent
...
- `unreal.TargetPoint`
  - `TargetPoint`
    - `TargetPoint.arrow_component`
    - `TargetPoint.sprite_component`