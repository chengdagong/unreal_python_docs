...
```python
class unreal.EditorUtilityEditableText(outer:Object | None=None, name:Name | str='None')
```
...
- `enable_integrated_keyboard` (bool): [Read-Write] Whether the integrated keyboard is enabled for this editable text.
