...
```python
class unreal.EditorUtilityMultiLineEditableText(outer:Object | None=None, name:Name | str='None')
```


**Bases:** ``MultiLineEditableText``
...
- `unreal.EditorUtilityMultiLineEditableText`
  - `EditorUtilityMultiLineEditableText`