...
```python
class unreal.CommonRotator(outer:Object | None=None, name:Name | str='None')
```
...
- `on_rotated` (OnRotated): [Read-Write]

- `on_rotated_with_direction` (OnRotatedWithDirection): [Read-Write] Called when the Selected state of this button changes. Provides the direction of rotation.
...
**bp_on_option_selected**( _index_) → `None`
...
**bp_on_options_populated**( _count_) → `None`
...
_property_ `my_text`: CommonTextBlock
...
_property_ `on_rotated`: OnRotated
...
_property_ `on_rotated_with_direction`: OnRotatedWithDirection

[Read-Write] Called when the Selected state of this button changes. Provides the direction of rotation.
...
**populate_text_labels**( _labels_) → `None`

Set the array of texts available

Parameters:

**labels** ( _Array_ _\_ [_Text_ _]_)


---

**set_selected_item**( _value_) → `None`
...
- `unreal.CommonRotator`
  - `CommonRotator`
    - `CommonRotator.bp_on_option_selected()`
    - `CommonRotator.bp_on_options_populated()`
    - `CommonRotator.get_selected_index()`
    - `CommonRotator.get_selected_text()`
    - `CommonRotator.my_text`
    - `CommonRotator.on_rotated`
    - `CommonRotator.on_rotated_with_direction`
    - `CommonRotator.populate_text_labels()`
    - `CommonRotator.set_selected_item()`
    - `CommonRotator.shift_text_left()`
    - `CommonRotator.shift_text_right()`