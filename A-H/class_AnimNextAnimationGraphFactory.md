# unreal.AnimNextAnimationGraphFactory

```python
class unreal.AnimNextAnimationGraphFactory(outer:Object | None=None, name:Name | str='None')
```
...
Anim Next Animation Graph Factory

**C++ Source:**

- **Plugin**: UAFAnimGraph

- **Module**: UAFAnimGraphEditor

- **File**: AnimNextAnimationGraphFactory.h
