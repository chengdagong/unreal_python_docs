...
```python
class unreal.DynamicMeshActor(outer:Object | None=None, name:Name | str='None')
```
...
**allocate_compute_mesh**() → `DynamicMesh`
...
_property_ `dynamic_mesh_component`: DynamicMeshComponent
...
_property_ `enable_compute_mesh_pool`: bool

[Read-Write] Control whether the DynamicMeshPool will be created when requested via GetComputeMeshPool()
...
**get_compute_mesh_pool**() → `DynamicMeshPool`
...
**get_dynamic_mesh_component**() → `DynamicMeshComponent`
...
**release_all_compute_meshes**() → `None`
...
**release_compute_mesh**( _mesh_) → `bool`
...
- `unreal.DynamicMeshActor`
  - `DynamicMeshActor`
    - `DynamicMeshActor.allocate_compute_mesh()`
    - `DynamicMeshActor.dynamic_mesh_component`
    - `DynamicMeshActor.enable_compute_mesh_pool`
    - `DynamicMeshActor.free_all_compute_meshes()`
    - `DynamicMeshActor.get_compute_mesh_pool()`
    - `DynamicMeshActor.get_dynamic_mesh_component()`
    - `DynamicMeshActor.release_all_compute_meshes()`
    - `DynamicMeshActor.release_compute_mesh()`