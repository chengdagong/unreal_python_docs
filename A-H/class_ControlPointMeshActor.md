...
```python
class unreal.ControlPointMeshActor(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `control_point_mesh_component`: ControlPointMeshComponent
...
- `unreal.ControlPointMeshActor`
  - `ControlPointMeshActor`
    - `ControlPointMeshActor.control_point_mesh_component`