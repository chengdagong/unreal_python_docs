...
```python
class unreal.AnimGraphNode_Base(outer:Object | None=None, name:Name | str='None')
```
...
Any concrete implementations will be paired with a runtime graph node derived from FAnimNode\_Base

**C++ Source:**

- **Module**: AnimGraph

- **File**: AnimGraphNode\_Base.h
