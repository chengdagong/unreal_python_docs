...
```python
class unreal.FleshActor(outer:Object | None=None, name:Name | str='None')
```
...
- `flesh_component` (FleshComponent): [Read-Only]
...
- `primary_solver` (DeformableSolverActor): [Read-Write]
...
**enable_simulation**( _actor_) → `None`

Enable Simulation

Parameters:

**actor** ( _DeformableSolverActor_)


---

_property_ `flesh_component`: FleshComponent
...
_property_ `primary_solver`: DeformableSolverActor

[Read-Write]

**Type:**

( DeformableSolverActor)

### Table of Contents

- `unreal.FleshActor`
  - `FleshActor`
    - `FleshActor.enable_simulation()`
    - `FleshActor.flesh_component`
    - `FleshActor.primary_solver`