# unreal.DrawFrustumComponent

```python
class unreal.DrawFrustumComponent(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `frustum_angle`: float

[Read-Write] Angle of longest dimension of view shape.
If the angle is 0 then an orthographic projection is used
...
_property_ `frustum_aspect_ratio`: float

[Read-Write] Ratio of horizontal size over vertical size.
...
_property_ `frustum_color`: Color

[Read-Write] Color to draw the wireframe frustum.
...
_property_ `frustum_enabled`: bool

[Read-Write] Enable or disable frustum visualization for this camera
...
_property_ `frustum_end_dist`: float

[Read-Write] Distance from origin to stop drawing the frustum.
...
_property_ `frustum_start_dist`: float

[Read-Write] Distance from origin to start drawing the frustum.
...
_property_ `texture`: Texture

[Read-Write] optional texture to show on the near plane
...
- `unreal.DrawFrustumComponent`
  - `DrawFrustumComponent`
    - `DrawFrustumComponent.frustum_angle`
    - `DrawFrustumComponent.frustum_aspect_ratio`
    - `DrawFrustumComponent.frustum_color`
    - `DrawFrustumComponent.frustum_enabled`
    - `DrawFrustumComponent.frustum_end_dist`
    - `DrawFrustumComponent.frustum_start_dist`
    - `DrawFrustumComponent.texture`