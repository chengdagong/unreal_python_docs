# unreal.WorldBookmarkFactory

```python
class unreal.WorldBookmarkFactory(outer:Object | None=None, name:Name | str='None')
```
...
World Bookmark Factory

**C++ Source:**

- **Module**: WorldBookmark

- **File**: WorldBookmarkFactory.h
