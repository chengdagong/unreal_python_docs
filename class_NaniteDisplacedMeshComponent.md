...
```python
class unreal.NaniteDisplacedMeshComponent(outer:Object | None=None, name:Name | str='None')
```
...
- **File**: NaniteDisplacedMeshComponent.h
...
- `displaced_mesh` (NaniteDisplacedMesh): [Read-Write]
...
_property_ `displaced_mesh`: NaniteDisplacedMesh
...
- `unreal.NaniteDisplacedMeshComponent`
  - `NaniteDisplacedMeshComponent`
    - `NaniteDisplacedMeshComponent.displaced_mesh`