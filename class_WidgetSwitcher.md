...
```python
class unreal.WidgetSwitcher(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `active_widget_index`: int

[Read-Write] The slot index to display
...
**get_widget_at_index**( _index_) → `Widget`
...
**set_active_widget**( _widget_) → `None`
...
**set_active_widget_index**( _index_) → `None`
...
- `unreal.WidgetSwitcher`
  - `WidgetSwitcher`
    ...
    - `WidgetSwitcher.get_active_widget()`
    - `WidgetSwitcher.get_active_widget_index()`
    - `WidgetSwitcher.get_num_widgets()`
    - `WidgetSwitcher.get_widget_at_index()`
    - `WidgetSwitcher.set_active_widget()`
    - `WidgetSwitcher.set_active_widget_index()`