...
```python
class unreal.ChaosSolverActor(outer:Object | None=None, name:Name | str='None')
```
...
**set_as_current_world_solver**() → `None`
...
**set_solver_active**( _active_) → `None`
...
- `unreal.ChaosSolverActor`
  - `ChaosSolverActor`
    - `ChaosSolverActor.set_as_current_world_solver()`
    - `ChaosSolverActor.set_solver_active()`