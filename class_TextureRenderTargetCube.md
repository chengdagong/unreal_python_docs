# unreal.TextureRenderTargetCube

```python
class unreal.TextureRenderTargetCube(outer:Object | None=None, name:Name | str='None')
```


**Bases:** ``TextureRenderTarget``
...
- `hdr` (bool): [Read-Write] Determines the format of the render target.
...
_property_ `auto_generate_mips`: bool

[Read-Only] Whether to support Mip maps for this render target texture
...
[Read-Only] Determines the format of the render target.
When enabled, the format is 16-bit RGBA. When disabled, the format is 8-bit BGRA.
...
_property_ `mips_sampler_filter`: TextureFilter

[Read-Only] Sampler filter type for AutoGenerateMips. Defaults to match texture filter.
...
_property_ `size_x`: int

[Read-Write] The width of the texture.
...
_property_ `supports_uav`: bool

[Read-Only] Whether this render target can be used as an unordered access view
...
- `unreal.TextureRenderTargetCube`
  - `TextureRenderTargetCube`
    - `TextureRenderTargetCube.auto_generate_mips`
    - `TextureRenderTargetCube.hdr`
    - `TextureRenderTargetCube.mips_sampler_filter`
    - `TextureRenderTargetCube.size_x`
    - `TextureRenderTargetCube.supports_uav`