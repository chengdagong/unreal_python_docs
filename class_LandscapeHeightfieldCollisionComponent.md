...
```python
class unreal.LandscapeHeightfieldCollisionComponent(outer:Object | None=None, name:Name | str='None')
```
...
**get_render_component**() → `LandscapeComponent`
...
- `unreal.LandscapeHeightfieldCollisionComponent`
  - `LandscapeHeightfieldCollisionComponent`
    - `LandscapeHeightfieldCollisionComponent.get_render_component()`