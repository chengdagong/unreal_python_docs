...
```python
class unreal.SkeletalMeshActor(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `should_do_anim_notifies`: bool

[Read-Write] Whether or not this actor should respond to anim notifies - CURRENTLY ONLY AFFECTS PlayParticleEffect NOTIFIES\*
...
_property_ `skeletal_mesh_component`: SkeletalMeshComponent
...
- `unreal.SkeletalMeshActor`
  - `SkeletalMeshActor`
    - `SkeletalMeshActor.should_do_anim_notifies`
