...
- `override_owner_velocity` (bool): [Read-Write] Option to override owner velocity used by spring controller.

- `owner_velocity_override` (Vector): [Read-Write]
...
_property_ `max_displacement`: float
...
- `unreal.AnimNode_SpringBone`
  - `AnimNode_SpringBone`
    - `AnimNode_SpringBone.max_displacement`