...
```python
class unreal.AnimGraphNode_BlendListByEnum(outer:Object | None=None, name:Name | str='None')
```
...
- **File**: AnimGraphNode\_BlendListByEnum.h
...
- `node` (AnimNode\_BlendListByEnum): [Read-Write]
