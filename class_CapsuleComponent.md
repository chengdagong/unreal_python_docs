...
```python
class unreal.CapsuleComponent(outer:Object | None=None, name:Name | str='None')
```


**Bases:** ``ShapeComponent``
...
_property_ `capsule_half_height`: float

[Read-Only] Half-height, from center of capsule to the end of top or bottom hemisphere.
This cannot be less than CapsuleRadius.
...
_property_ `capsule_height`: float

‘capsule\_height’ was renamed to ‘capsule\_half\_height’.
...
_property_ `capsule_radius`: float

[Read-Only] Radius of cap hemispheres and center cylinder.
This cannot be more than CapsuleHalfHeight.
...
**get_scaled_capsule_half_height**() → `float`
...
**get_scaled_capsule_half_height_without_hemisphere**() → `float`
...
**get_scaled_capsule_radius**() → `float`
...
get\_scaled\_capsule\_size( _)->(out\_radius=float_, _out\_half\_height=float_)

Returns the capsule radius and half-height scaled by the component scale. Half-height includes the hemisphere end cap.

Returns:

out\_radius (float): Radius of the capsule, scaled by the component scale.

out\_half\_height (float): Half-height of the capsule, scaled by the component scale. Includes the hemisphere end cap.

Return type:

tuple

get\_scaled\_capsule\_size\_without\_hemisphere( _)->(out\_radius=float_, _out\_half\_height\_without\_hemisphere=float_)

Returns the capsule radius and half-height scaled by the component scale. Half-height excludes the hemisphere end cap.

Returns:

out\_radius (float): Radius of the capsule, ignoring component scaling.

out\_half\_height\_without\_hemisphere (float): Half-height of the capsule, scaled by the component scale. Excludes the hemisphere end cap.
...
**get_unscaled_capsule_half_height**() → `float`
...
**get_unscaled_capsule_half_height_without_hemisphere**() → `float`
...
**get_unscaled_capsule_radius**() → `float`
...
get\_unscaled\_capsule\_size( _)->(out\_radius=float_, _out\_half\_height=float_)
...
get\_unscaled\_capsule\_size\_without\_hemisphere( _)->(out\_radius=float_, _out\_half\_height\_without\_hemisphere=float_)
...
**set_capsule_half_height**( _half_height_, _update_overlaps=True_) → `None`
...
- **half\_height** ( _float_) – : half-height, from capsule center to end of top or bottom hemisphere.
...
**set_capsule_radius**( _radius_, _update_overlaps=True_) → `None`
...
- **radius** ( _float_) – : radius of end-cap hemispheres and center cylinder.
...
**set_capsule_size**( _radius_, _half_height_, _update_overlaps=True_) → `None`
...
- `unreal.CapsuleComponent`
  - `CapsuleComponent`
    - `CapsuleComponent.capsule_half_height`
    - `CapsuleComponent.capsule_height`
    - `CapsuleComponent.capsule_radius`
    - `CapsuleComponent.get_scaled_capsule_half_height()`
    - `CapsuleComponent.get_scaled_capsule_half_height_without_hemisphere()`
    - `CapsuleComponent.get_scaled_capsule_radius()`
    - `CapsuleComponent.get_scaled_capsule_size()`
    - `CapsuleComponent.get_scaled_capsule_size_without_hemisphere()`
    - `CapsuleComponent.get_shape_scale()`
    - `CapsuleComponent.get_unscaled_capsule_half_height()`
    - `CapsuleComponent.get_unscaled_capsule_half_height_without_hemisphere()`
    - `CapsuleComponent.get_unscaled_capsule_radius()`
    - `CapsuleComponent.get_unscaled_capsule_size()`
    - `CapsuleComponent.get_unscaled_capsule_size_without_hemisphere()`
    - `CapsuleComponent.set_capsule_half_height()`
    - `CapsuleComponent.set_capsule_radius()`
    - `CapsuleComponent.set_capsule_size()`