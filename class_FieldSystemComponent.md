...
```python
class unreal.FieldSystemComponent(outer:Object | None=None, name:Name | str='None')
```
...
**add_field_command**( _enabled_, _target_, _meta_data_, _field_) → `NoneAddConstructionField`
...
- **enabled** ( _bool_) – Is this force enabled for evaluation.

- **target** ( _FieldPhysicsType_) – Type of field supported by the solver.

- **meta\_data** ( _FieldSystemMetaData_) – Meta data used to assist in evaluation

- **field** ( _FieldNodeBase_) – Base evaluation node for the field network.



---

**add_persistent_field**( _enabled_, _target_, _meta_data_, _field_) → `NoneAddPersistentField`
...
**apply_linear_force**( _enabled_, _direction_, _magnitude_) → `NoneApplyUniformForce`
...
- **direction** ( _Vector_) – The direction of the linear force

- **magnitude** ( _float_) – The size of the linear force.



---

**apply_physics_field**( _enabled_, _target_, _meta_data_, _field_) → `NoneAddTransientField`
...
**apply_radial_force**( _enabled_, _position_, _magnitude_) → `NoneApplyRadialForce`
...
- **position** ( _Vector_) – The origin point of the force
...
**apply_radial_vector_falloff_force**( _enabled_, _position_, _radius_, _magnitude_) → `NoneFalloffRadialForce`
...
- **radius** ( _float_) – Radial influence from the position, positions further away are weaker.
...
**apply_stay_dynamic_field**( _enabled_, _position_, _radius_) → `NoneSetDynamicState`
...
- **position** ( _Vector_) – The location of the command

- **radius** ( _float_) – Radial influence from the position



---

**apply_strain_field**( _enabled_, _position_, _radius_, _magnitude_, _iterations_) → `NoneApplyExternalStran`
...
- **iterations** ( _int32_) – Levels of evaluation into the cluster hierarchy.



---

**apply_uniform_vector_falloff_force**( _enabled_, _position_, _direction_, _radius_, _magnitude_) → `NoneFalloffUniformForce`
...
_property_ `field_system`: FieldSystem

[Read-Only] Field system asset to be used to store the construction fields. This asset is not required anymore and will be deprecated soon.
...
- `unreal.FieldSystemComponent`
  - `FieldSystemComponent`
    - `FieldSystemComponent.add_field_command()`
    - `FieldSystemComponent.add_persistent_field()`
    - `FieldSystemComponent.apply_linear_force()`
    - `FieldSystemComponent.apply_physics_field()`
    - `FieldSystemComponent.apply_radial_force()`
    - `FieldSystemComponent.apply_radial_vector_falloff_force()`
    - `FieldSystemComponent.apply_stay_dynamic_field()`
    - `FieldSystemComponent.apply_strain_field()`
    - `FieldSystemComponent.apply_uniform_vector_falloff_force()`
    - `FieldSystemComponent.field_system`
    - `FieldSystemComponent.remove_persistent_fields()`
    - `FieldSystemComponent.reset_field_system()`