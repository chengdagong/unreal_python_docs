# unreal.VectorFieldComponent

```python
class unreal.VectorFieldComponent(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `intensity`: float

[Read-Write] The intensity at which the vector field is applied.
...
**set_intensity**( _new_intensity_) → `None`

Set the intensity of the vector field.

Parameters:

**new\_intensity** ( _float_) – The new intensity of the vector field.


---

_property_ `tightness`: float

[Read-Write] How tightly particles follow the vector field.
...
_property_ `vector_field`: VectorField

[Read-Write] The vector field asset.
...
- `unreal.VectorFieldComponent`
  - `VectorFieldComponent`
    - `VectorFieldComponent.intensity`
    - `VectorFieldComponent.set_intensity()`
    - `VectorFieldComponent.tightness`
    - `VectorFieldComponent.vector_field`