...
```python
class unreal.RigVMFunction_MathFloatFloor(value:float=0.0, result:float=0.0, int:int=0)
```
...
- `unreal.RigVMFunction_MathFloatFloor`
  - `RigVMFunction_MathFloatFloor`
    - `RigVMFunction_MathFloatFloor.int`
    - `RigVMFunction_MathFloatFloor.result`
    - `RigVMFunction_MathFloatFloor.value`