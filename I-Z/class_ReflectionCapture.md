...
```python
class unreal.ReflectionCapture(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `capture_component`: ReflectionCaptureComponent

[Read-Only] Reflection capture component.
...
- `unreal.ReflectionCapture`
  - `ReflectionCapture`
    - `ReflectionCapture.capture_component`