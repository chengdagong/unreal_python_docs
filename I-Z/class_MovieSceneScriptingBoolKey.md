...
```python
class unreal.MovieSceneScriptingBoolKey(outer:Object | None=None, name:Name | str='None')
```
...
Parameters:\
\
**new\_value** ( _bool_) – The new value for this key.\
\
### Table of Contents\
\
- `unreal.MovieSceneScriptingBoolKey`\
  - `MovieSceneScriptingBoolKey`\
    - `MovieSceneScriptingBoolKey.get_time()`\
    - `MovieSceneScriptingBoolKey.get_value()`\
    - `MovieSceneScriptingBoolKey.set_time()`\
    - `MovieSceneScriptingBoolKey.set_value()`\
\