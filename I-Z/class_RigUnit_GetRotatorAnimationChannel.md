...
```python
class unreal.RigUnit_GetRotatorAnimationChannel(control:Name='None', channel:Name='None', initial:bool=False, value:Rotator=Ellipsis)
```
...
- `unreal.RigUnit_GetRotatorAnimationChannel`
  - `RigUnit_GetRotatorAnimationChannel`
    - `RigUnit_GetRotatorAnimationChannel.value`