...
```python
class unreal.TextRenderActor(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `text_render`: TextRenderComponent

[Read-Only] Component to render a text in 3d with a font
