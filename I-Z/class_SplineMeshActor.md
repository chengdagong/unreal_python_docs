...
```python
class unreal.SplineMeshActor(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `spline_mesh_component`: SplineMeshComponent
...
- `unreal.SplineMeshActor`
  - `SplineMeshActor`
    - `SplineMeshActor.spline_mesh_component`