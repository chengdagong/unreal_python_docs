...
```python
class unreal.WindDirectionalSource(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `component`: WindDirectionalSourceComponent
...
- `unreal.WindDirectionalSource`
  - `WindDirectionalSource`
    - `WindDirectionalSource.component`