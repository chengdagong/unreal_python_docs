# unreal.MetaHumanAudioBaseLiveLinkSubjectSettings

```python
class unreal.MetaHumanAudioBaseLiveLinkSubjectSettings(outer:Object | None=None, name:Name | str='None')
```
...
MetaHuman Audio Base Live Link Subject Settings
...
- **File**: MetaHumanAudioBaseLiveLinkSubjectSettings.h
...
**get_mood**() → `AudioDrivenAnimationMood`

Get Mood

Returns:

out\_mood (AudioDrivenAnimationMood):
...
**get_mood_intensity**() → `float`

Get Mood Intensity

Returns:

out\_mood\_intensity (float):
...
**set_lookahead**( _lookahead_) → `None`
...
**set_mood**( _mood_) → `None`

Set Mood

Parameters:

**mood** ( _AudioDrivenAnimationMood_)


---

**set_mood_intensity**( _mood_intensity_) → `None`

Set Mood Intensity

Parameters:

**mood\_intensity** ( _float_)

### Table of Contents

- `unreal.MetaHumanAudioBaseLiveLinkSubjectSettings`
  - `MetaHumanAudioBaseLiveLinkSubjectSettings`
    - `MetaHumanAudioBaseLiveLinkSubjectSettings.get_lookahead()`
    - `MetaHumanAudioBaseLiveLinkSubjectSettings.get_mood()`
    - `MetaHumanAudioBaseLiveLinkSubjectSettings.get_mood_intensity()`
    - `MetaHumanAudioBaseLiveLinkSubjectSettings.set_lookahead()`
    - `MetaHumanAudioBaseLiveLinkSubjectSettings.set_mood()`
    - `MetaHumanAudioBaseLiveLinkSubjectSettings.set_mood_intensity()`