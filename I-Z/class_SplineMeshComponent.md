# unreal.SplineMeshComponent

```python
class unreal.SplineMeshComponent(outer:Object | None=None, name:Name | str='None')
```
...
**get_forward_axis**() → `SplineMeshAxis`
...
**set_boundary_max**( _boundary_max_, _update_mesh=True_) → `None`

Set the boundary max

Parameters:

- **boundary\_max** ( _float_)
...
**set_boundary_min**( _boundary_min_, _update_mesh=True_) → `None`

Set the boundary min

Parameters:

- **boundary\_min** ( _float_)
...
**set_end_offset**( _end_offset_, _update_mesh=True_) → `None`

Set the end offset

Parameters:

- **end\_offset** ( _Vector2D_)
...
**set_end_position**( _end_pos_, _update_mesh=True_) → `None`
...
**set_end_roll**( _end_roll_, _update_mesh=True_) → `None`
...
**set_end_roll_degrees**( _end_roll_degrees_, _update_mesh=True_) → `None`

Set the end roll in degrees

Parameters:

- **end\_roll\_degrees** ( _float_)
...
**set_end_scale**( _end_scale=[1.000000, 1.000000]_, _update_mesh=True_) → `None`

Set the end scaling

Parameters:

- **end\_scale** ( _Vector2D_)
...
**set_end_tangent**( _end_tangent_, _update_mesh=True_) → `None`

Set the end tangent vector of spline in local space

Parameters:

- **end\_tangent** ( _Vector_)
...
**set_forward_axis**( _forward_axis_, _update_mesh=True_) → `None`

Set the forward axis

Parameters:

- **forward\_axis** ( _SplineMeshAxis_)
...
**set_spline_up_dir**( _spline_up_dir_, _update_mesh=True_) → `None`

Set the spline up direction

Parameters:

- **spline\_up\_dir** ( _Vector_)
...
**set_start_and_end**( _start_pos_, _start_tangent_, _end_pos_, _end_tangent_, _update_mesh=True_) → `None`
...
**set_start_offset**( _start_offset_, _update_mesh=True_) → `None`

Set the start offset

Parameters:

- **start\_offset** ( _Vector2D_)
...
**set_start_position**( _start_pos_, _update_mesh=True_) → `None`
...
**set_start_roll**( _start_roll_, _update_mesh=True_) → `None`
...
**set_start_roll_degrees**( _start_roll_degrees_, _update_mesh=True_) → `None`

Set the start roll in degrees

Parameters:

- **start\_roll\_degrees** ( _float_)
...
**set_start_scale**( _start_scale=[1.000000, 1.000000]_, _update_mesh=True_) → `None`

Set the start scaling

Parameters:

- **start\_scale** ( _Vector2D_)
...
**set_start_tangent**( _start_tangent_, _update_mesh=True_) → `None`
...
- `unreal.SplineMeshComponent`
  - `SplineMeshComponent`
    - `SplineMeshComponent.get_boundary_max()`
    - `SplineMeshComponent.get_boundary_min()`
    - `SplineMeshComponent.get_end_offset()`
    - `SplineMeshComponent.get_end_position()`
    - `SplineMeshComponent.get_end_roll()`
    - `SplineMeshComponent.get_end_scale()`
    - `SplineMeshComponent.get_end_tangent()`
    - `SplineMeshComponent.get_forward_axis()`
    - `SplineMeshComponent.get_spline_up_dir()`
    - `SplineMeshComponent.get_start_offset()`
    - `SplineMeshComponent.get_start_position()`
    - `SplineMeshComponent.get_start_roll()`
    - `SplineMeshComponent.get_start_scale()`
    - `SplineMeshComponent.get_start_tangent()`
    - `SplineMeshComponent.set_boundary_max()`
    - `SplineMeshComponent.set_boundary_min()`
    - `SplineMeshComponent.set_end_offset()`
    - `SplineMeshComponent.set_end_position()`
    - `SplineMeshComponent.set_end_roll()`
    - `SplineMeshComponent.set_end_roll_degrees()`
    - `SplineMeshComponent.set_end_scale()`
    - `SplineMeshComponent.set_end_tangent()`
    - `SplineMeshComponent.set_forward_axis()`
    - `SplineMeshComponent.set_spline_up_dir()`
    - `SplineMeshComponent.set_start_and_end()`
    - `SplineMeshComponent.set_start_offset()`
    - `SplineMeshComponent.set_start_position()`
    - `SplineMeshComponent.set_start_roll()`
    - `SplineMeshComponent.set_start_roll_degrees()`
    - `SplineMeshComponent.set_start_scale()`
    - `SplineMeshComponent.set_start_tangent()`
    - `SplineMeshComponent.update_mesh()`