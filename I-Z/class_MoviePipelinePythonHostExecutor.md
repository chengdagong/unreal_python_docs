...
```python
class unreal.MoviePipelinePythonHostExecutor(outer:Object | None=None, name:Name | str='None')
```


**Bases:** ``MoviePipelineExecutorBase``
...
**execute_delayed**( _pipeline_queue_) → `None`

Python/Blueprint API

Parameters:

**pipeline\_queue** ( _MoviePipelineQueue_)


---

_property_ `executor_class`: Class
...
_property_ `pipeline_queue`: MoviePipelineQueue
...
- `unreal.MoviePipelinePythonHostExecutor`
  - `MoviePipelinePythonHostExecutor`
    - `MoviePipelinePythonHostExecutor.execute_delayed()`
    - `MoviePipelinePythonHostExecutor.executor_class`
    - `MoviePipelinePythonHostExecutor.get_last_loaded_world()`
    - `MoviePipelinePythonHostExecutor.on_map_load()`
    - `MoviePipelinePythonHostExecutor.pipeline_queue`