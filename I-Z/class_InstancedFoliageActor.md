...
```python
class unreal.InstancedFoliageActor(outer:Object | None=None, name:Name | str='None')
```


**Bases:** ``ISMPartitionActor``
...
_classmethod_ add_instances( _world_context_object_, _foliage_type_, _transforms_)→None
...
- **foliage\_type** ( _FoliageType_)

- **transforms** ( _Array_ _\_ [_Transform_ _]_)



---

**get_instance_transforms**( _foliage_type_, _instances_level=None_) → `Array\ [Transform]`
...
**get_used_foliage_types**() → `Array\ [FoliageType]`
...
_classmethod_ remove_all_instances( _world_context_object_, _foliage_type_)→None
...
- `unreal.InstancedFoliageActor`
  - `InstancedFoliageActor`
    - `InstancedFoliageActor.add_instances()`
    - `InstancedFoliageActor.get_instance_transforms()`
    - `InstancedFoliageActor.get_used_foliage_types()`
    - `InstancedFoliageActor.remove_all_instances()`