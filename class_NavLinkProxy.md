...
```python
class unreal.NavLinkProxy(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `nav_links`: None

‘nav\_links’ was renamed to ‘point\_links’.
...
_property_ `on_smart_link_reached`: SmartLinkReachedSignature

[Read-Write]

**Type:**

( SmartLinkReachedSignature)


---

_property_ `point_links`: None

[Read-Only] Navigation links (point to point) added to navigation data
...
**receive_smart_link_reached**( _agent_, _destination_) → `None`
...
- **destination** ( _Vector_)



---

**resume_path_following**( _agent_) → `None`
...
**set_smart_link_enabled**( _enabled_) → `None`
...
- `unreal.NavLinkProxy`
  - `NavLinkProxy`
    - `NavLinkProxy.has_moving_agents()`
    - `NavLinkProxy.is_smart_link_enabled()`
    - `NavLinkProxy.nav_links`
    - `NavLinkProxy.on_smart_link_reached`
    - `NavLinkProxy.point_links`
    - `NavLinkProxy.receive_smart_link_reached()`
    - `NavLinkProxy.resume_path_following()`
    - `NavLinkProxy.set_smart_link_enabled()`