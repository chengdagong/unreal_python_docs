...
```python
class unreal.TextRenderComponent(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `always_render_as_text`: bool

[Read-Only] Allows text to draw unmodified when using debug visualization modes. \*
...
_property_ `horiz_spacing_adjust`: float

[Read-Only] Horizontal adjustment per character, default is 0.0
...
_property_ `horizontal_alignment`: HorizTextAligment

[Read-Only] Horizontal text alignment
...
**set_horiz_spacing_adjust**( _value_) → `None`
...
**set_horizontal_alignment**( _value_) → `None`

Change the horizontal alignment and signal the primitives to be rebuilt

Parameters:

**value** ( _HorizTextAligment_)


---

**set_text**( _value_) → `None`
...
**set_text_material**( _material_) → `None`
...
**set_text_render_color**( _value_) → `None`
...
**set_vert_spacing_adjust**( _value_) → `None`
...
**set_vertical_alignment**( _value_) → `None`

Change the vertical alignment and signal the primitives to be rebuilt

Parameters:

**value** ( _VerticalTextAligment_)


---

**set_world_size**( _value_) → `None`
...
_property_ `text`: Text

[Read-Only] Text content, can be multi line using <br> as line separator
...
_property_ `text_material`: MaterialInterface

[Read-Only] Text material
...
_property_ `text_render_color`: Color

[Read-Only] Color of the text, can be accessed as vertex color
...
_property_ `vert_spacing_adjust`: float

[Read-Only] Vertical adjustment per character, default is 0.0
...
_property_ `vertical_alignment`: VerticalTextAligment

[Read-Only] Vertical text alignment
...
_property_ `world_size`: float

[Read-Only] Vertical size of the fonts largest character in world units. Transform, XScale and YScale will affect final size.
...
_property_ `x_scale`: float

[Read-Only] Horizontal scale, default is 1.0
...
_property_ `y_scale`: float

[Read-Only] Vertical scale, default is 1.0
...
- `unreal.TextRenderComponent`
  - `TextRenderComponent`
    - `TextRenderComponent.always_render_as_text`
    - `TextRenderComponent.font`
    - `TextRenderComponent.get_text_local_size()`
    - `TextRenderComponent.get_text_world_size()`
    - `TextRenderComponent.horiz_spacing_adjust`
    - `TextRenderComponent.horizontal_alignment`
    - `TextRenderComponent.set_font()`
    - `TextRenderComponent.set_horiz_spacing_adjust()`
    - `TextRenderComponent.set_horizontal_alignment()`
    - `TextRenderComponent.set_text()`
    - `TextRenderComponent.set_text_material()`
    - `TextRenderComponent.set_text_render_color()`
    - `TextRenderComponent.set_vert_spacing_adjust()`
    - `TextRenderComponent.set_vertical_alignment()`
    - `TextRenderComponent.set_world_size()`
    - `TextRenderComponent.set_x_scale()`
    - `TextRenderComponent.set_y_scale()`
    - `TextRenderComponent.text`
    - `TextRenderComponent.text_material`
    - `TextRenderComponent.text_render_color`
    - `TextRenderComponent.vert_spacing_adjust`
    - `TextRenderComponent.vertical_alignment`
    - `TextRenderComponent.world_size`
    - `TextRenderComponent.x_scale`
    - `TextRenderComponent.y_scale`