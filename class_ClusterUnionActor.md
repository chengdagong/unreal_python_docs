# unreal.ClusterUnionActor

```python
class unreal.ClusterUnionActor(outer:Object | None=None, name:Name | str='None')
```
...
_property_ `cluster_union`: ClusterUnionComponent

[Read-Only] The pivot used while building.
...
- `unreal.ClusterUnionActor`
  - `ClusterUnionActor`
    - `ClusterUnionActor.cluster_union`