...
```python
class unreal.SpotLight(outer:Object | None=None, name:Name | str='None')
```
...
**set_inner_cone_angle**( _new_inner_cone_angle_) → `None`
...
**new\_inner\_cone\_angle** ( _float_)


---

**set_outer_cone_angle**( _new_outer_cone_angle_) → `None`
...
**new\_outer\_cone\_angle** ( _float_)


---

_property_ `spot_light_component`: SpotLightComponent
...
- `unreal.SpotLight`
  - `SpotLight`
    - `SpotLight.set_inner_cone_angle()`
    - `SpotLight.set_outer_cone_angle()`
