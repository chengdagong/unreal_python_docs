...
```python
class unreal.PhasedAutomationActorBase(outer:Object | None=None, name:Name | str='None')
```
...
**on_functional_testing_begin**() → `None`
...
**on_functional_testing_complete**() → `None`
...
- `unreal.PhasedAutomationActorBase`
  - `PhasedAutomationActorBase`
    - `PhasedAutomationActorBase.on_functional_testing_begin()`
    - `PhasedAutomationActorBase.on_functional_testing_complete()`