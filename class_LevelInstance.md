...
```python
class unreal.LevelInstance(outer:Object | None=None, name:Name | str='None')
```
...
- `unreal.LevelInstance`
  - `LevelInstance`
    - `LevelInstance.get_loaded_level()`
    - `LevelInstance.get_world_asset()`
    - `LevelInstance.is_loaded()`
    - `LevelInstance.load_level_instance()`
    - `LevelInstance.set_world_asset()`
    - `LevelInstance.unload_level_instance()`