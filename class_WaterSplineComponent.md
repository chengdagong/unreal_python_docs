...
```python
class unreal.WaterSplineComponent(outer:Object | None=None, name:Name | str='None')
```


**Bases:** ``SplineComponent``
...
- `unreal.WaterSplineComponent`
  - `WaterSplineComponent`
    - `WaterSplineComponent.k2_synchronize_and_broadcast_data_change()`