...
```python
class unreal.AnimGraphNode_BlendBoneByChannel(outer:Object | None=None, name:Name | str='None')
```
...
- **File**: AnimGraphNode\_BlendBoneByChannel.h
...
- `blend_node` (AnimNode\_BlendBoneByChannel): [Read-Write]
